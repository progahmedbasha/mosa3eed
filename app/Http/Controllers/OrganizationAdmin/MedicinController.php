...
class MedicinController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('organization.pages.medicins.medicins', compact('medicins'));
    }
    ...
    {
        return view('organization.pages.medicins.medicin_add');
    }
    ...
    public function edit($id)
    {
        ...
        return view('organization.pages.medicins.medicin_details', compact('medicin'));
    }
