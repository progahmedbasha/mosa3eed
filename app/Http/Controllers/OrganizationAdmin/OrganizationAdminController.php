...
class OrganizationAdminController extends Controller
{
    ...
    public function create($id)
    {
      $user_types = UserType::skip(1)->skip(2)->take(2)->get();
        return view('organization.pages.organization_admins.organization_admin_add', compact('id','user_types'));
    }
    ...
    public function edit($id,$org)
    {
        ...
        $user_types = UserType::skip(1)->skip(2)->take(2)->get();
        return view('organization.pages.organization_admins.organization_admin_details', compact('org_admin','user_types','organization'));
    }
