...
class BranchController extends Controller
{
    ...
    {
        $branchs = Branch::where('organization_id',Auth::user()->organization_id)->whenSearch($request->search)->paginate(50);
    ...
    public function edit($id)
    {
        ...
        return view('organization.pages.branchs.branch_details', compact('branch','organizations','countries','cities','districts','country_id','city_id'));
    }
