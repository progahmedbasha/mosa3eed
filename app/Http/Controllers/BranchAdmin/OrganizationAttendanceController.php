...
class OrganizationAttendanceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('branch_admin.pages.organization_attendances.organization_attendances', compact('organization_attendances'));
    }
    ...
    public function create()
    {
        ...
        $users = User::all();
        $branches = Branch::all();
        return view('branch_admin.pages.organization_attendances.organization_attendance_add', compact('organizations','users','branches'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('branch_attendances.index')->with('success','Organization Attendance Added Successfully');  
    }
