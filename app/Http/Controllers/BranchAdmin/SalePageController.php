...
class SalePageController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('branch_admin.pages.pos.sale_page', compact('order_number','branches'));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('branch_admin.pages.sale_bills.sale_bill_items_show', compact('sale_bills','sale_number','id'));
    }
    ...
    public function destroy($id)
    {
        ...
        $bill->delete();
        return redirect()->route('branch_admin_sale_page.index')->with('success','SaleBill Deleted Successfully');
    }
    public function item_edite($order , $id)
    {
        ...
        $medicins = Medicin::all();
         return view('branch_admin.pages.sale_bills.sale_bill_item_edit', compact('bill_item','bill_number','medicins'));
    }
    public function item_update(Request $request , $id)
    {
        ...
        $item->save();
      return redirect()->route('branch_admin_sale_page.show',$bill_number)->with('success','Request Updated Successfully');
    }
    public function  order_item_delete($order, $id)
    {
        $bill = SaleBillProduct::find($id);
        $bill->delete();
        return redirect()->route('branch_admin_sale_page.show',$order)->with('success','Item Deleted Successfully');
    }
