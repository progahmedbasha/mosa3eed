...
use App\Http\Requests\OrganizationDashboard\BranchAdmin\BranchAdminStoreRequest;
use App\Http\Requests\OrganizationDashboard\BranchAdmin\BranchAdminUpdateRequest;
   ...
   public function create($org, $branch_id )
    {
        ...
        return view('organization.pages.branch_admins.branch_admin_add', compact('branch_id','org','countries','cities','districts','shifts'));
    }
    ...
    public function store(BranchAdminStoreRequest $request)
    {
        ...
        return redirect()->route('org_admins_branch', ['org' => $org,'branch' => $branch])->with('success','Branch Admin Added Successfully');
    }
      ...
      public function edit($org , $branch ,$id )
    {
        ...
        return view('organization.pages.branch_admins.branch_admin_details', compact('id','user','shifts','branch','org','user_branch'));
    }
       ...
       public function update(BranchAdminUpdateRequest $request, $id)
    {
        ...
        $org = $request->org_id;
        return redirect()->route('org_admins_branch', ['org' => $org,'branch' => $branch_id])->with('success','Branch Admin Updated Successfully');
    }
    ...
    public function admins_branch($org , $branch)
    {
        ...
        return view('branch_admin.pages.branch_admins.branch_admins', compact('admins','org','branch'));
    }
}