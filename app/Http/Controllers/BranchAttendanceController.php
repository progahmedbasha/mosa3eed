...
class BranchAttendanceController extends Controller
{
    ...
    public function create($id)
    {
        ...
        $users = User::all();
        $branches = Branch::all();
        return view('admin.pages.organization_attendances.organization_attendance_add', compact('organizations','users','branches','id'));
    }
    public function easysign()
    {
        ...
        $organizations = Organization::all();
        $branches = Branch::all();
        return view('admin.pages.organization_attendances.sign_add', compact('users','branches','organizations'));
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('org_branch_attendance',$branch->id)->with('success','Organization Attendance Added Successfully');  
    }
