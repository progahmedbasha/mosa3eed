						...
						<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="d-flex d-lg-none align-items-center ms-n2 me-2">
								...
								<a href="../../demo3/dist/index.html" class="d-flex align-items-center">
									<img alt="Logo" src="{{asset('assets/media/logos/logo-demo3-default.svg')}}" class="h-20px" />
								</a>
								<!--end::Logo-->
							</div>
							<!--end::Wrapper-->
											...
											<div class="card-body py-0">
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="symbol symbol-40px symbol-2by3 me-4">
														<img src="{{asset('assets/media/stock/600x400/img-20.jpg')}}" alt="" class="mw-100" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													<!--begin::Image-->
													<div class="symbol symbol-40px symbol-2by3 me-4">
														<img src="{{asset('assets/media/stock/600x400/img-25.jpg')}}" alt="" class="mw-100" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													<!--begin::Image-->
													<div class="symbol symbol-40px symbol-2by3 me-4">
														<img src="{{asset('assets/media/stock/600x400/img-24.jpg')}}" alt="" class="mw-100" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													<!--begin::Image-->
													<div class="symbol symbol-40px symbol-2by3 me-4">
														<img src="{{asset('assets/media/stock/600x400/img-19.jpg')}}" alt="" class="mw-100" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
												...
												<div class="d-flex flex-nowrap align-items-center">
													<!--begin::Image-->
													<div class="symbol symbol-40px symbol-2by3 me-4">
														<img src="{{asset('assets/media/stock/600x400/img-27.jpg')}}" alt="" class="mw-100" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
										...
										<div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
											...
											<div class="card-body">
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													<!--begin::Image-->
													<div class="symbol symbol-40px symbol-2by3 me-4">
														<img src="{{asset('assets/media/stock/600x400/img-1.jpg')}}" alt="" class="mw-100" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													<!--begin::Image-->
													<div class="symbol symbol-40px symbol-2by3 me-4">
														<img src="{{asset('assets/media/stock/600x400/img-2.jpg')}}" alt="" class="mw-100" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													<!--begin::Image-->
													<div class="symbol symbol-40px symbol-2by3 me-4">
														<img src="{{asset('assets/media/stock/600x400/img-3.jpg')}}" alt="" class="mw-100" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													<!--begin::Image-->
													<div class="symbol symbol-40px symbol-2by3 me-4">
														<img src="{{asset('assets/media/stock/600x400/img-5.jpg')}}" alt="" class="mw-100" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
												...
												<div class="d-flex flex-nowrap align-items-center">
													<!--begin::Image-->
													<div class="symbol symbol-40px symbol-2by3 me-4">
														<img src="{{asset('assets/media/stock/600x400/img-6.jpg')}}" alt="" class="mw-100" />
													</div>
													<!--end::Image-->
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
