								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-title">
										...
										<div class="d-flex align-items-center position-relative my-1">
											...
											<!--end::Svg Icon-->
											<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Branches">
										</div>
										<!--end::Search-->
									</div>
									<!--begin::Card title-->
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
											...
											{{-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Customer</button>
											 --}}
												<a href="{{route('branchs.create')}}" class="btn btn-primary">Add</a>
									...
									<div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
										...
										<thead>
											...
											<th class="w-10px pe-2 sorting_disabled" rowspan="1" colspan="1" aria-label=" " style="width: 29.25px;">
													...
													<th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label=" Organization: activate to sort column ascending" style="width: 125px;">Organization</th>
													<th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label=" Email: activate to sort column ascending" style="width: 125px;">Email</th>
													<th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label=" Address: activate to sort column ascending" style="width: 125px;">Address</th>
										...
										<tr class="odd">
												...
												<!--begin::Name=-->
												<td>
													<a href="branchs/{{$branch->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $branch->name }}</a>
												</td>
												<!--end::Name=-->
												<!--begin::Name=-->
												<td>
													<a href="branchs/{{$branch->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $branch->Organization->name }}</a>
												</td>
												<td>
													<a href="branchs/{{$branch->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $branch->email }}</a>
												</td>
												<td>
													<a href="branchs/{{$branch->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $branch->address }}</a>
												</td>
												<!--end::Name=-->
												...
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="branchs/{{$branch->id}}/edit" class="menu-link px-3">View</a>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
