...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Organization Admin List</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">Organization Admin Listing</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--begin::Card-->
								  ...
								  @endif
									...
									<div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
										...
										<tbody class="fw-bold text-gray-600">
										 ...
										 @foreach($organization_admins as $index=>$organization_admin)	
										<tr class="odd">
												<!--begin::Checkbox-->
												<td>
												...
												<!--begin::Name=-->
												<td>
													<a href="admin/{{$organization_admin->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $organization_admin->name }}</a>
												</td>
											
												<td>
													<a href="admin/{{$organization_admin->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $organization_admin->email }}</a>
												</td>
												<td>
													<a href="admin/{{$organization_admin->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $organization_admin->phone }}</a>
												</td>
												<td>
													<a href="admin/{{$organization_admin->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $organization_admin->UserType->type }}</a>
												</td>
												<!--end::Email=-->
