                  ...
                  <div class="row">
                     ...
                     <div class="col mb-3">
                        <form method="get" class="form-inline" action="{{url('admin/organization_attendances')}}"
                           ...
                           <a href="{{url('admin/organization_attendances')}}" class="btn btn-light-primary me-3"
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="btn-icon-list">
                                    <form action="{{route('organization_attendances.destroy',$org_attendance->id)}}"
                                       method="POST">
                                       @csrf
                                       @method('DELETE')
                                       <a href="organization_attendances/{{$org_attendance->id}}/edit"
