   ...
   <div class="col-xl-12 mb-30">
      <div class="card card-statistics h-100">
         <div class="card-body">
            ...
            <div class="row">
               <div class="col mb-3">
                  <a href="{{ route('organization_attendances.create') }}" class="btn  btn-outline-primary">Add</a>
               </div>
               {{-- search --}}
               <div class="col mb-3">
                  <form method="get" class="form-inline" action="{{url('admin/organization_attendances')}}" style="margin-left: 45%;">
                     ...
                     <a href="{{url('admin/organization_attendances')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i
               ...
               <table id="datatable" class="table table-striped table-bordered p-0">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>{{ $org_attendance->Organization->name }}</td>
                        <td>{{ $org_attendance->Branch->name}}</td>
                        <td>{{ $org_attendance->date }} {{ $org_attendance->time }}</td>
                        <td>{{ $org_attendance->type }}</td>
                        <td>
                           <div class="btn-icon-list">
                              <form action="{{route('organization_attendances.destroy',$org_attendance->id)}}" method="POST">
                                 @csrf
                                 @method('DELETE')
                                 <a href="organization_attendances/{{$org_attendance->id}}/edit" class="btn btn-info"><i
