      ...
      <div class="card-header border-0 pt-6">
         ...
         <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
               <form method="get" class="form-inline" action="{{url('admin/organization_attendances')}}">
                  <input class="form-control form-control-solid w-250px ps-15" name="search" type="text" placeholder="Search Attendance" required>
            </div>
            <!--end::Search-->
         </div>
         <!--begin::Card title-->
         ...
         <a href="{{url('admin/organization_attendances')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i class="fa fa-times"></i></a>
         </form>
         {{-- paginate --}}
      ...
      <div class="card-body pt-0">
         ...
         <div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
            <div class="table-responsive">
               ...
               {{ $organization_attendances->links() }}
            </div>
            <!--end::Table-->
         </div>
         <!--end::Card body-->
