...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Add New Attendance</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">Attendance Add</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--begin::Card-->
...
<br>
							<div >
								<span class="fs-2x fw-bolder text-gray-800">Form Attendance</span>
							</div>

                  <form action="{{route('organization_attendances.store')}}" method="post" enctype="multipart/form-data">
                     @csrf
								 ...
								 <div class="row gx-10 mb-5">
                                                    ...
                                                    <!--begin::Input group-->
															...
															<div class="mb-5">
															<input type="date" class="form-control form-control-solid" placeholder="Date" value="{{old('date')}}" name="date">
																@error('date')
																<div class="alert alert-danger">{{ $message }}</div>
																@enderror   														
															</div>
													...
													<!--begin::Input group-->
                                                       ...
                                                       <!--begin::Input group-->
															...
															<div class="mb-5">
															<input type="time" class="form-control form-control-solid" placeholder="Time" value="{{old('time')}}" name="time">
																@error('time')
																<div class="alert alert-danger">{{ $message }}</div>
																@enderror   														
															</div>
