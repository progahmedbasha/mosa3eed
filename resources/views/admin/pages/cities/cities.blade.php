   ...
   <div class="col-xl-12 mb-30">
      <div class="card card-statistics h-100">
         <div class="card-body">
            ...
            <div class="row">
               <div class="col mb-3">
                  <a href="{{ route('cities.create') }}" class="btn  btn-outline-primary">Add</a>
               </div>
               {{-- search --}}
               <div class="col mb-3">
                  <form method="get" class="form-inline" action="{{url('admin/cities')}}"
                     ...
                     <a href="{{url('admin/cities')}}" class="btn btn-light-primary me-3"
                        ...
                        <td>
                           <div class="btn-icon-list">
                              <form action="{{route('cities.destroy',$city->id)}}" method="POST">
                                 @csrf
                                 @method('DELETE')
                                 <a href="cities/{{$city->id}}/edit" class="btn btn-info"><i
