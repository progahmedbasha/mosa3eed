      ...
      <div class="card card-statistics h-100">
         <div class="card-body">
            ...
            <div class="row">
               ...
               {{-- search --}}
               <div class="col mb-3">
                  <form method="get" class="form-inline" action="{{url('admin/organization_shifts')}}" style="margin-left: 45%;">
                     ...
                     <a href="{{url('admin/organization_shifts')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i
