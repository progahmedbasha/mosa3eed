...
<div class="container" id="kt_content_container">
   ...
   <div class="card">
      ...
      <div class="card-header border-0 pt-6">
         ...
         <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
               <form method="get" class="form-inline" action="{{url('admin/organization_shifts')}}">
                  <input class="form-control form-control-solid w-250px ps-15" name="search" type="text" placeholder="Search Shift" required>
            </div>
            <!--end::Search-->
         </div>
         <!--begin::Card title-->
         ...
         <a href="{{url('admin/organization_shifts')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i class="fa fa-times"></i></a>
         </form>
         {{-- paginate --}}
