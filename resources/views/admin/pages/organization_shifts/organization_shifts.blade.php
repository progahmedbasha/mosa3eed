								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-title">
										...
										<div class="d-flex align-items-center position-relative my-1">
											...
											<!--end::Svg Icon-->
											<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Shifts">
										</div>
										<!--end::Search-->
									</div>
									<!--begin::Card title-->
								  ...
								  @endif
									...
									<div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
										...
										<tr class="odd">
												...
												<!--begin::Name=-->
												<td>
													<a href="admin/{{$shift->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $shift->Shift->name }}</a>
												</td>
