   ...
   <div class="col-xl-3 col-sm-6 mb-3">
      <div class="channels-card">
         <div class="channels-card-image">
            ...
            <a href="branch_admins/{{$admin->id}}/edit"><img src="{{url('/data/admins')}}/{{$admin->User->photo }}" class="img-fluid" alt=""></a>
            @else
            <a href="branch_admins/{{$admin->id}}/edit"><img src="{{url('/data/user_error.png')}}" class="img-fluid" alt=""></a>
            @endif
           
            <div class="channels-card-image-btn"><button type="button" class="btn btn-success btn-sm border-none"> {{ $admin->User->Organization->name }}
         ...
         <div class="channels-card-body">
            <div class="channels-title">
               <a href="#">{{ $admin->User->name }} <span title="" data-placement="top" data-toggle="tooltip"
