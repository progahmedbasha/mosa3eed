         ...
         <div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
            <div class="table-responsive">
               <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
                  ...
                  <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label="Comment: activate to sort column ascending" style="width: 165.203px;">Comment</th>
                  ...
                  <tbody class="fw-bold text-gray-600">
                     ...
                     <tr class="odd">
                        ...
                        <!--begin::Name=-->
                       <td>
							<a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $post_comment->User->name }}</a>
						</td>
                        <td>
							<a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $post_comment->comment }}</a>
						</td>
                        <td>
							<a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $post_comment->status }}</a>
						</td>
                        <td class="text-end">
                                <form action="{{route('comment_status_change',$post_comment->id)}} " method="POST">
                                    @csrf
                                    {{-- @method('patch') --}}
                                    {{-- <button  class="menu-link px-3" style="background: transparent;border: 0;" data-kt-customer-table-filter="delete_row">Hide</button> --}}
