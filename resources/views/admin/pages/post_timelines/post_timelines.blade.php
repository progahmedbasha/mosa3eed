                     ...
                     <tr class="odd">
                       ...
                       <td>
                        ...
                        <td>
                                <?php
                                $total = 0;
                                foreach ($post_timeline->PostLike as $key => $val) {
                                    $total =  $val->count();
                                    }
                                    // echo $total;

                                ?>
                           <a href="post_like/{{$post_timeline->id}}" class="text-gray-800 text-hover-primary mb-1"> {{$total}}</a>
						...
						<td>
                                <?php
                                $total = 0;
                                foreach ($post_timeline->PostComment as $key => $val) {
                                    $total =  $val->count();
                                    }
                                    // echo $total;
                                ?>
                              <a href="post_comment/{{$post_timeline->id}}" class="text-gray-800 text-hover-primary mb-1"> {{$total}}</a>
