			...
			<div class="col-xl-12 mb-30">
				<div class="card card-statistics h-100">
					<div class="card-body">
						...
						<form action="{{route('effective_materials.update',$material->id)}}" method="post" enctype="multipart/form-data">
							@csrf
                            @method('patch')
							<div class="form-row">
								<div class="col">
									...
									<input type="text" class="form-control form-control-solid" placeholder="Name En"
										value="{{$material->getTranslation('name', 'en')}}" name="name_en">
									@error('name_en')
								...
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control form-control-solid" placeholder="Name Ar"
										value="{{$material->getTranslation('name', 'ar')}}" name="name_ar">
									@error('name_ar')
									<div class="alert alert-danger">{{ $message }}</div>
									@enderror
								</div>
