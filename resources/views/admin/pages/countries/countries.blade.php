      ...
      <div class="card card-statistics h-100">
         <div class="card-body">
            ...
            <div class="row">
               ...
               {{-- search --}}
               <div class="col mb-3">
                  <form method="get" class="form-inline" action="{{url('admin/countries')}}"
                     ...
                     <a href="{{url('admin/countries')}}" class="btn btn-light-primary me-3"
                        ...
                        <td>
                           <div class="btn-icon-list">
                              <form action="{{route('countries.destroy',$country->id)}}" method="POST">
                                 @csrf
                                 @method('DELETE')
                                 <a href="countries/{{$country->id}}/edit" class="btn btn-info"><i
