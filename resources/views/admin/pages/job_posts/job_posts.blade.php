   ...
   <div class="col-xl-12 mb-30">
      <div class="card card-statistics h-100">
         <div class="card-body">
            ...
            <div class="row">
               <div class="col mb-3">
                  <a href="{{ route('job_posts.create') }}" class="btn  btn-outline-primary">Add</a>
               </div>
               {{-- search --}}
               <div class="col mb-3">
                  <form method="get" class="form-inline" action="{{url('admin/job_posts')}}" style="margin-left: 45%;">
                     ...
                     <a href="{{url('admin/job_posts')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i
            ...
            <div class="table-responsive" style="text-align:center;">
               <table id="datatable" class="table table-striped table-bordered p-0">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>{{ $index+1 }}</td>
                        <td>{{ $job_post->subject }}</td>
                        <td>{{ $job_post->Organization->name }}</td>
                        @if(!empty($job_post->branch_id ))
                        <td>{{ $job_post->Branch->name  }}</td>
                        @endif
                        ...
                        <td>
                           <div class="btn-icon-list">
                              <form action="{{route('job_posts.destroy',$job_post->id)}}" method="POST">
                                 @csrf
                                 @method('DELETE')
                                 <a href="job_posts/{{$job_post->id}}/edit" class="btn btn-info"><i
