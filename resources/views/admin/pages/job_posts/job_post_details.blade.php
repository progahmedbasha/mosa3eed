                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="mb-5">
                              <input type="text" class="form-control form-control-solid" placeholder="Subject"
                                 value="{{$job_post->subject}}" name="subject">
                              @error('subject')
                           ...
                           <div class="mb-5">
                              <select id="organization" class="form-control organization_id" name="organization_id">
                                 <option value="{{$job_post->organization_id}}"
                                    {{($organization_id==$organization_id)? 'selected' : '' }}>
                                    {{$organization_id->name}}</option>
                                 <option value="">----------------------------------------------------------</option>
                           ...
                           <div id="branch_block" @if(!empty($job_post->branch_id)) style="display: none"; @endif >
                              ...
                              <div class="mb-5">
                                 <select id="country-dd" class="form-control" name="country_id">
                                    ...
                                    <option value="{{$item->id}}" {{(old('country_id')==$country_id)? 'selected' :''}}>
                                       {{$item->name}}</option>
                                    @endforeach
                                 </select>
                                 @error('country_id')
                              ...
                              <div class="mb-5">
                                 <select id="state-dd" class="form-control" name="district_id">
                                    ...
                                    <option value="{{$job_post->district_id}}" {{($job_post->district_id ==
                                       $job_post->district_id)? 'selected' : '' }}> {{$job_post->District->name}}
                                    </option>
                                    <option value="">----------------------------------------------------------</option>
                                    @foreach ($districts as $district)
                                    <option value="{{$district->id}}" {{(old('distict_id')==$district->id)?
                           ...
                           <div class="mb-5">
                              <textarea class="form-control" aria-label="With textarea" value="{{$job_post->breif}}"
                                 name="breif">{{$job_post->breif}}</textarea>
                              @error('breif')
                              <div class="alert alert-danger">{{ $message }}</div>
                              @enderror
                           </div>
                           ...
                           <div class="mb-5">
                              <input type="text" class="form-control form-control-solid" placeholder="Email Contract"
                                 value="{{$job_post->email_contract}}" name="email_contract">
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="mb-5">
                              <select id="title-dd" class="form-control" name="job_title_id">
                                 <option value="{{$job_post->job_title_id}}" {{($job_post->job_title_id ==
                                    $job_post->job_title_id)? 'selected' : '' }}> {{$job_post->JobTitle->name}}</option>
                           ...
                           <div class="mb-5">
                              <select id="branch-dd" class="form-control" name="branch_id">
                                 ...
                                 <option value="{{$job_post->branch_id}}" {{($branch_id==$branch_id)? 'selected' : ''
                                    }}> {{$branch_id->name}}</option>
                                 @endif
                                 <option value="">----------------------------------------------------------</option>
                           ...
                           <option value="{{$city->id}}" {{(old('city_id')==$city->id)? 'selected':''}}>{{$city->name}}
                                    ...
                                    <option value="">----------------------------------------------------------</option>
                                    @foreach ($cities as $city)
                                    <option value="{{$city->id}}" {{(old('country_id')==$city_id)? 'selected' :''}}>
                                       {{$city->name}}</option>
                                    @endforeach
                                 </select>
                                 @error('due_date')
                              ...
                              <div class="mb-5">
                                 <input type="text" class="form-control form-control-solid" placeholder="Address"
                                    value="{{$job_post->address}}" name="address">
                                 @error('address')
                                 <div class="alert alert-danger">{{ $message }}</div>
                                 @enderror
                              </div>
                           ...
                           <div class="mb-5">
                              <textarea class="form-control" aria-label="With textarea" value="{{$job_post->experince}}"
                                 name="experince">{{$job_post->experince}}</textarea>
                              @error('experince')
                              <div class="alert alert-danger">{{ $message }}</div>
                              @enderror
                           </div>
                           ...
                           <div class="mb-5">
                              <input type="text" class="form-control form-control-solid" placeholder="Expected Salary"
                                 value="{{$job_post->expected_salary}}" name="expected_salary">
                           ...
                           <div class="mb-5">
                              <input type="text" class="form-control form-control-solid" placeholder="Phone Contract"
                                 value="{{$job_post->phone_contract}}" name="phone_contract">
