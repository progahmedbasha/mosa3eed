...
<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
   ...
   <ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
      ...
      <li class="breadcrumb-item text-dark">Job Post Add</li>
   </ul>
   <!--end::Breadcrumb-->
</div>
<!--begin::Card-->
            ...
            <form action="{{route('job_posts.store')}}" method="post" enctype="multipart/form-data">
               ...
               <div class="row gx-10 mb-5">
                  ...
                  <div class="col-lg-6">
                     ...
                     <div class="mb-5">
                        <input type="text" class="form-control form-control-solid" placeholder="Email Contract" value="{{old('email_contract')}}" name="email_contract">
                  ...
                  <div class="col-lg-6">
                     ...
                     <div class="mb-5">
                        <input type="text" class="form-control form-control-solid" placeholder="Expected Salary" value="{{old('expected_salary')}}" name="expected_salary">
                     ...
                     <div class="mb-5">
                        <input type="text" class="form-control form-control-solid" placeholder="Phone Contract" value="{{old('phone_contract')}}" name="phone_contract">
