   ...
   <div class="col-xl-12 mb-30">
      <div class="card card-statistics h-100">
         <div class="card-body">
            ...
            <div class="row">
               <div class="col mb-3">
                  <a href="{{ route('purchases.create') }}" class="btn  btn-outline-primary">Add</a>
               </div>
               {{-- search --}}
               <div class="col mb-3">
                  <form method="get" class="form-inline" action="{{url('admin/purchases')}}" style="margin-left: 45%;">
                     ...
                     <a href="{{url('admin/purchases')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i
                        ...
                        <td>
                           <div class="btn-icon-list">
                              <form action="{{route('purchases.destroy',$purchase->id)}}" method="POST">
                                 @csrf
                                 @method('DELETE')
                                 <a href="purchases/{{$purchase->id}}/edit" class="btn btn-info"><i
