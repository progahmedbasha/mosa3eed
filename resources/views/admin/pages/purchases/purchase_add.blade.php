						...
						<form action="{{route('purchases.store')}}" method="post" enctype="multipart/form-data">
							...
							<div class="row gx-10 mb-5">
								...
								<div class="col-lg-6">
									...
									<!--begin::Input group-->
									<!--begin::Input group-->
									<label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Type Of
										Measurement</label>
									<div class="mb-5">
										<input type="text" class="form-control form-control-solid"
											placeholder="Type Of Measurement" value="{{old('type_measurement')}}"
								...
								<div class="col-lg-6">
									...
									<div class="mb-5">
										<input type="text" class="form-control form-control-solid"
											placeholder="Acd Custom Item" value="{{old('acd')}}" name="acd">
										@error('acd')
										<div class="alert alert-danger">{{ $message }}</div>
										@enderror
									</div>
									...
									<div class="mb-5">
										<input type="date" class="form-control form-control-solid"
											placeholder="Due Date" value="{{old('due_date')}}" name="due_date">
										@error('due_date')
										<div class="alert alert-danger">{{ $message }}</div>
										@enderror
									</div>
