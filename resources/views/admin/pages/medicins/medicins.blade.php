      ...
      <div class="card-header border-0 pt-6">
         ...
         <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
               <form method="get" class="form-inline" action="{{url('admin/medicins')}}">
         ...
         <a href="{{url('admin/medicins')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i class="fa fa-times"></i></a>
         </form>
         {{-- paginate --}}
