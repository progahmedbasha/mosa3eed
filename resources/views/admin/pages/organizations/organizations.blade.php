                     ...
                     <div class="video-card-image">
                        ...
                        <div class="dropdown">
                           <a type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"
                              style="margin-top: 13px;margin-left: 220px;">
                              <i class="fas fa-ellipsis-v"></i>
                           </a>
                           <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                              <li><a class="dropdown-item" style="padding: 3px 14px!important"
                                    href="organizations/{{$organization->id}}/edit"><i class="fas fa-eye"></i> View &
                                    Edit
                                 </a></li>
                              <li><a class="dropdown-item" style="padding: 3px 14px!important"
                              ...
                              <li><a class="dropdown-item" style="padding: 3px 14px!important"
                                    href="employees/{{ $organization->id }}"><i class="fas fa-users"></i> employees</a>
                              </li>
                              <li>
