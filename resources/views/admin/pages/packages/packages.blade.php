...
<div class="container" id="kt_content_container">
   <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
      <!--begin::Heading-->
      <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Package  List</h1>
      <!--end::Heading-->
      <!--begin::Breadcrumb-->
               ...
               <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
                  ...
                  <tbody class="fw-bold text-gray-600">
                     ...
                     <tr class="odd">
                        ...
                        <!--begin::Name=-->
                       <td>
							<a href="packages/{{$package->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $package->subject }}</a>
						</td>
					
						<td>
							<a href="packages/{{$package->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $package->UserType->type }}</a>
						</td>
						<td>
							<a href="packages/{{$package->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $package->price}} </a>
						</td>
                        <td>
							<a href="packages/{{$package->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $package->number_days}}</a>
						</td>
						<td>
							<a href="packages/{{$package->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $package->offer}}</a>
						</td>
                         <td>
							<a href="purchases/{{$package->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $package->status }}</a>
						</td>
                        <!--end::Name=-->
                        <!--begin::Action=-->
                        <td class="text-end">
                           ...
                           <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                              ...
                              <div class="menu-item px-3">
								<a href="packages/{{$package->id}}/edit" class="menu-link px-3">View</a>
                              </div>
                              <!--end::Menu item-->
                              <!--begin::Menu item-->
                              <div class="menu-item px-3">
