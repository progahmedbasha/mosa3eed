...
<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
   <!--begin::Heading-->
   <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Add New Package</h1>
   <!--end::Heading-->
   <!--begin::Breadcrumb-->
   <ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
      ...
      <li class="breadcrumb-item text-dark">Package Add</li>
   </ul>
   <!--end::Breadcrumb-->
</div>
<!--begin::Card-->
   ...
   <div class="card-body pt-0">
      ...
      <div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
         <div class="table-responsive">
            <br>
            <div >
               <span class="fs-2x fw-bolder text-gray-800">Form Package</span>
            </div>
            <form action="{{route('packages.store')}}" method="post" enctype="multipart/form-data">
               ...
               <div class="row gx-10 mb-5">
                  ...
                  <div class="col-lg-6">
                     ...
                     <div class="mb-5">
                        <input type="text" class="form-control form-control-solid" placeholder="Subject" value="{{old('subject')}}" name="subject">
                        @error('subject')
                     ...
                     <div class="mb-5">
                        <textarea class="form-control" aria-label="With textarea"value="{{old('description')}}" name="description"></textarea>
                        @error('description')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror   														
                     </div>
                  ...
                  <div class="col-lg-6">
                     <!--begin::Input group-->
                     <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Number Of Days</label>
                     <div class="mb-5">
                        <input type="text" class="form-control form-control-solid" placeholder="number_days" value="{{old('number_days')}}" name="number_days">
                        @error('number_days')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror   														
                     </div>
                     ...
                     <!--begin::Input group-->
                     <!--begin::Input group-->
                     <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Offer</label>
                     <div class="mb-5">
                        <input type="text" class="form-control form-control-solid" placeholder="Offer" value="{{old('offer')}}" name="offer">
                        @error('offer')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror   														
                     </div>
