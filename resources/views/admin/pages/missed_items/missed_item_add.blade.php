			...
			<div class="col-xl-12 mb-30">
				<div class="card card-statistics h-100">
					<div class="card-body">
						...
						<form action="{{route('missed_items.store')}}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="form-row">
								<div class="col">
									...
									<select id="country-dd" class="form-control" name="user_id">
										...
										<option value="{{$user->id}}" {{(old('organization_id')==$user->id)?
							...
							<div class="form-row">
								<div class="col">
									...
									<textarea class="form-control" aria-label="With textarea" value="{{old('notes')}}"
										name="notes"></textarea>
									@error('notes')
									<div class="alert alert-danger">{{ $message }}</div>
									@enderror
