...
<div class="container" id="kt_content_container">
   <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
      ...
      <ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
         ...
         <li class="breadcrumb-item text-dark">Missed Item List</li>
      </ul>
      <!--end::Breadcrumb-->
   </div>
   <!--begin::Card-->
      ...
      <div class="card-header border-0 pt-6">
         ...
         <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
               <form method="get" class="form-inline" action="{{url('admin/missed_items')}}">
                  <input class="form-control form-control-solid w-250px ps-15" name="search" type="text" placeholder="Search Missed Items" required>
            </div>
            <!--end::Search-->
         </div>
         <!--begin::Card title-->
         ...
         <a href="{{url('admin/missed_items')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i class="fa fa-times"></i></a>
         </form>
         {{-- paginate --}}
         <a href="{{route('missed_items.create')}}" class="btn btn-primary">Add</a>
         <!--end::Add customer-->
         </div>
         <!--end::Toolbar-->
         </div>
               ...
               <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
                  ...
                  <thead>
                     ...
                     <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0" role="row">
                       ...
                       <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label="Medicin Name: activate to sort column ascending" style="width: 165.203px;">Medicin Name</th>
						<th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label="User Name: activate to sort column ascending" style="width: 165.203px;">User Name</th>
                        ...
                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label="Notes: activate to sort column ascending" style="width: 165.203px;">Notes</th>
                  ...
                  <tbody class="fw-bold text-gray-600">
                     ...
                     <tr class="odd">
                        ...
                        <!--begin::Name=-->
                       <td>
							<a href="purchases/{{$missed_item->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $missed_item->Medicin->name }}</a>
						</td>
					
						<td>
							<a href="purchases/{{$missed_item->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $missed_item->User->name }}</a>
						</td>
						<td>
							<a href="purchases/{{$missed_item->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $missed_item->Branch->name }}</a>
						</td>
						<td>
							<a href="purchases/{{$missed_item->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $missed_item->notes }}</a>
						</td>
                  <td>
							<a href="purchases/{{$missed_item->id}}/edit" class="text-gray-600 text-hover-primary mb-1">{{ $missed_item->status }}</a>
						</td>
                        <!--end::Name=-->
                        <!--begin::Action=-->
                        <td class="text-end">
                           ...
                           <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                              ...
                              <div class="menu-item px-3">
								<a href="missed_items/{{$missed_item->id}}/edit" class="menu-link px-3">View</a>
                              </div>
                              <!--end::Menu item-->
                              <!--begin::Menu item-->
                              <div class="menu-item px-3">
