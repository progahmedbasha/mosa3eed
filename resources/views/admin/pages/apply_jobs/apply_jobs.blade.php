      ...
      <div class="card-header border-0 pt-6">
         ...
         <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
               <form method="get" class="form-inline" action="{{url('admin/job_applies')}}">
         ...
         <a href="{{url('admin/job_applies')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i class="fa fa-times"></i></a>
         </form>
         {{-- paginate --}}
            ...
            <div class="table-responsive">
               <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
                  ...
                  <thead>
                     ...
                     <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0" role="row">
                       ...
                       <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label="User: activate to sort column ascending" style="width: 165.203px;">User</th>
						<th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label="Job: activate to sort column ascending" style="width: 165.203px;">Job</th>
						<th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label="CV Attachment: activate to sort column ascending" style="width: 165.203px;">CV Attachment</th>
                  ...
                  <tbody class="fw-bold text-gray-600">
                      @foreach($job_applies as $index=>$job_apply)		
                     <tr class="odd">
                        <!--begin::Checkbox-->
                        <td>
                        ...
                        <!--begin::Name=-->
                       <td>
							<a href="job_applies/{{$job_apply->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $job_apply->User->name }}</a>
						</td>
                        ...
                        <td class="text-end">
                           ...
                           <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                              ...
                              <div class="menu-item px-3">
								<a href="job_applies/{{$job_apply->id}}/edit" class="menu-link px-3">View</a>
                              </div>
                              <!--end::Menu item-->
                              <!--begin::Menu item-->
                              <div class="menu-item px-3">
                                 <form action="{{route('job_applies.destroy',$job_apply->id)}} " method="POST">
									@csrf
									@method('DELETE')
