                    ...
                    @method('patch')
								 <div class="row gx-10 mb-5">
														...
														<div class="col-lg-6">
															...
															<!--begin::Input group-->
															<div class="mb-5">
																<input type="text" class="form-control form-control-solid" placeholder="Name" value="{{$data->name}}" name="name">
																@error('name')
															...
															<div class="mb-5">
																<input type="text" class="form-control form-control-solid" placeholder="Email" value="{{$data->email}}" name="email">
																@error('email')
																<div class="alert alert-danger">{{ $message }}</div>
																@enderror	
                                                            </div>
															...
															<div class="mb-5">
																<select  id="inputState" class="form-control" style="padding: 10px;" name="user_type_id">
																	...
																	<option value="{{$item->id}}" {{(old('institution_id')==$item->id)? 'selected':''}} >{{$item->type}}</option>
																	@endforeach
																</select>
																@error('user_type_id')
																<div class="alert alert-danger">{{ $message }}</div>
														...
														<div class="col-lg-6">
															...
															<!--begin::Input group-->
															<div class="mb-5">
																<input type="text" class="form-control form-control-solid" placeholder="Phone" value="{{$data->phone}}" name="phone">
																@error('phone')
																<div class="alert alert-danger">{{ $message }}</div>
																@enderror	
                                                            </div>
															...
															<div class="mb-5">
																	<select id="state-dd" class="form-control"style="padding: 10px;" name="district_id">
																		<option value="{{$data->district_id}}" {{($data->district_id == $data->district_id)? 'selected' : '' }}> {{$data->District->name}}</option>
																	</select>
																	@error('district_id')
																	<div class="alert alert-danger">{{ $message }}</div>
																	@enderror   												
