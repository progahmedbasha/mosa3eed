                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="video-card history-video">
                                <div class="video-card-image">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item"
                                                    ...
                                                    href="{{route('user_branch_accept',$branch->id)}} "><i
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <li><a class="dropdown-item"
                                                    style="padding: 0px 14px!important; font-size:14px;"
                                                    href="{{ route('admins_branch', ['org'	=> $branch->organization_id, 'branch' => $branch->branch_id])}}"><i
                                                        class="fas fa-user-circle"></i>
                                                    Branch Admins</a>
                                            </li>
                                            <li>
                                                <form action="{{route('branchs.destroy',$branch->branch_id)}} "
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    <a href="{{route('branchs.edit',$branch->branch_id)}} ">
                                        @if(!empty($branch->photo))
                                        <img class="img-fluid" src="{{url('/data/branchs')}}/{{$branch->photo }}" alt=""
                                            style="height: 154px;">
                                        @else
                                ...
                                <div class="video-card-body">
                                    ...
                                    <div class="video-page text-success" style="text-align: center;">
                                        {{$branch->Organization->name }} <a title="" data-placement="top"
                                            data-toggle="tooltip" href="#" data-original-title="Verified">
                                            @if ($branch->status ==1)
