         ...
         <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col mb-3">
                        <a href="{{ route('branch_employees.create') }}" class="btn  btn-outline-primary">Add</a>
                     </div>
                     {{-- search --}}
                     <div class="col mb-3">
                        <form method="get" class="form-inline" action="{{url('branch_admin/branch_employees')}}"
                           ...
                           <a href="{{url('branch_admin/branch_employees')}}" class="btn btn-light-primary me-3"
                              ...
                              <td>
                                 <div class="btn-icon-list">
                                    <form action="{{route('branch_employees.destroy',$employee->id)}}" method="POST">
                                       @csrf
                                       @method('DELETE')
                                       <a href="{{route('branch_employees.edit',$employee->id)}}"
