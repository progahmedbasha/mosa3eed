...
<div class="modal" id="ModalAddEdit{{ $ad->id }}">
    ...
    <div class="modal-content modal-content-demo">
        ...
        <div id="alertadd{{$ad->id}}" class="alert alert-success" style="display:none;">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body" style="text-align: left;">
                        <form method="POST" action="{{route('branch_ads.update',$ad->id)}}"
                            ...
                            <div id="branch_block2">
                                <div class="image-area" 
                                    ...
                                    <img class="img" src="{{url('/data/org_ads')}}/{{$ad->photo }}"
                                        alt="Preview">
                                    <a class="remove-image" onclick="mysFunction(add{{$ad->id}} , inputadd{{$ad->id}} , alertadd{{$ad->id}} )" style="display: inline;">&#215;</a>
                                </div>
                            </div>
                            <input type="hidden" id="inputadd{{ $ad->id }}" name="img_delete">
                            <br>
                            <div class="mg-t-30">
...
<script>
     ...
     function mysFunction(id , inputadd,alertadd) {
        console.log(id);
