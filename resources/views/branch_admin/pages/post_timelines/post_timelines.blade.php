         ...
         <div class="row">
            <div class="col-md-8">
               <div class="single-video-left">
                  ...
                  @include('branch_admin.pages.post_timelines.add_post_component')
                           ...
                           <div class="reviews-members">
                              <div class="media">
                                 ...
                                 <div class="media-body">
                                    <div class="reviews-members-header">
                                       ...
                                       <div class="dropdown" style="margin-left: 100%; margin-top: -3%;">
                                          ...
                                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                             ...
                                             View & Edit</button>
                                             <li>
                                                <form action="{{route('branch_admin_timeline_posts.destroy',$post_timeline->id)}} "
                                                   method="POST">
                                                   @csrf
                                                   @method('DELETE')
                                    ...
                                    <br>
                                    @include('branch_admin.pages.post_timelines.edit_post_modal')
            ...
            @include('branch_admin.pages.post_timelines.right_nav')
         </div>
      </div>
      <hr>
   </div>
     ...
     $(document).ready(function(){
             ...
             $('.actives').on('click ', function (e) {
               ...
               //   var new_id = $('.new_id').val();
                 ...
                 $.ajax({
                     url: "{{route('branch_change_comment_satus')}}",
                     type: "POST",
                     data: {
                         active: active,
                         new_id:new_id,
   ...
   ////add comment to post
     function commentFunction(id , inputad,div) {
      //   console.log(inputad);
                 ...
                 $.ajax({
                     url: "{{route('branch_add_comment_ajax')}}",
                     type: "POST",
                     data: {
                         id:id,
                         input_id:input_id,
