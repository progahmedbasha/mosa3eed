      ...
      <div class="card-header border-0 pt-6">
         ...
         <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
               <form method="get" class="form-inline" action="{{url('organization/branch_admin_sale_page')}}">
         ...
         <a href="{{url('organization/branch_admin_sale_page')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i class="fa fa-times"></i></a>
         </form>
         {{-- paginate --}}
               ...
               <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
                  ...
                  <tbody class="fw-bold text-gray-600">
                     ...
                     <tr class="odd">
                        ...
                        <!--begin::Name=-->
                       <td>
							<a href="{{route('branch_admin_sale_page.show',$sale_bill->id)}}" class="text-gray-800 text-hover-primary mb-1">{{$sale_bill->bill_number}}</a>
						</td>

                         <td>
							<a href="{{route('branch_admin_sale_page.show',$sale_bill->id)}}" class="text-gray-600 text-hover-primary mb-1">{{$sale_bill->User->name}}</a>
						</td>
                              <td>
							<a href="{{route('branch_admin_sale_page.show',$sale_bill->id)}}" class="text-gray-600 text-hover-primary mb-1">{{$sale_bill->Branch->name}}</a>
						</td>
                        <td>
                            <a href="{{route('branch_admin_sale_page.show',$sale_bill->id)}}" class="text-gray-800 text-hover-primary mb-1">{{$sale_bill->sale_bill_product_count}}</a>
                        </td>
                        <td>
                            <?php
                                $total = 0;
                        ...
                        <td>
                           <a href="{{route('branch_admin_sale_page.show',$sale_bill->id)}}" class="text-gray-600 text-hover-primary mb-1">{{$sale_bill->status}}</a>
                        </td>
                         <td>
                           <a href="{{route('branch_admin_sale_page.show',$sale_bill->id)}}" class="text-gray-600 text-hover-primary mb-1">{{$sale_bill->created_at}}</a>
                        </td>
                        <!--end::Name=-->
                        <!--begin::Action=-->
                        <td class="text-end">
                           ...
                           <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                              ...
                              <div class="menu-item px-3">
								<a href="{{route('branch_admin_sale_page.show',$sale_bill->id)}}" class="menu-link px-3">View</a>
                              </div>
                              <!--end::Menu item-->
                              <!--begin::Menu item-->
                              <div class="menu-item px-3">
                                 <form action="{{route('branch_admin_sale_page.destroy',$sale_bill->id)}} " method="POST">
									@csrf
									@method('DELETE')
