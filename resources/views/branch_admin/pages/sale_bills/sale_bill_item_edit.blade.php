            ...
            <div class="container" id="kt_content_container">
               <div
                  ...
                  <ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
                     ...
                     <li class="breadcrumb-item text-dark">Item Edit</li>
                  </ul>
                  <!--end::Breadcrumb-->
               </div>
               <!--begin::Card-->
                                 ...
                                 <div class="col-lg-6">
                                    ...
                                    <div class="mb-5">
                                       <select class="form-control" name="medicin_id">
                                          <option value="{{$bill_item->medicin_id}}" {{($bill_item->medicin_id ==
                                             $bill_item->medicin_id)? 'selected' : '' }}>{{$bill_item->Medicin->name}}
                                          </option>
                                 ...
                                 <form id="kt_customers_export_form"
                                    ...
                                    <div class="fv-row mb-10">
                                       ...
                                       <span class="select2 select2-container select2-container--bootstrap5" dir="ltr"
                                          data-select2-id="select2-data-14-ayn2" style="width: 100%;"><span
                                             class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-format-0f-container"
                                                aria-controls="select2-format-0f-container"><span
                                                   class="select2-selection__rendered" id="select2-format-0f-container"
