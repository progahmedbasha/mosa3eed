								...
								<div class="col-lg-6">
									...
									<div class="mb-5">
										<select id="inputState" class="form-control" name="user_type_id">
											<option value="{{$user->user_type_id}}" {{($user->user_type_id =
												$user->user_type_id )? 'selected' : '' }}> {{$user->UserType->type}}
											</option>
											<option>----------------------------------------------------------</option>
									...
									<div class="mb-5">
										<select id="city-dd" class="form-control" name="city_id">
											<option {{($city_id=$city_id)? 'selected' : '' }}> {{$city_id->name}}
											</option>
										</select>
									</div>
									<!--end::Input group-->
								...
								<div class="col-lg-6">
									...
									<div class="mb-5">
										<select id="country-dd" class="form-control" name="country_id">
											<option {{($country_id=$country_id)? 'selected' : '' }}>
												{{$country_id->name}}</option>
									...
									<div class="mb-5">
										<select id="state-dd" class="form-control" name="district_id">
											<option value="{{$user->district_id}}" {{($user->district_id ==
												$user->district_id)? 'selected' : '' }}> {{$user->District->name}}
											</option>
										</select>
										@error('district_id')
										<div class="alert alert-danger">{{ $message }}</div>
								...
								<form id="kt_customers_export_form"
									...
									<div class="fv-row mb-10">
										...
										<select data-control="select2" data-placeholder="Select a format"
											...
											data-select2-id="select2-data-13-xm76" tabindex="-1" aria-hidden="true">
											<option value="excell" data-select2-id="select2-data-15-u3st">Excel</option>
											<option value="pdf">PDF</option>
											<option value="cvs">CVS</option>
											<option value="zip">ZIP</option>
										</select><span class="select2 select2-container select2-container--bootstrap5"
											dir="ltr" data-select2-id="select2-data-14-ayn2" style="width: 100%;"><span
