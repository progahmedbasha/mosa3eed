...
<div class="container" id="kt_content_container">
   ...
   <div class="card">
      ...
      <div class="card-header border-0 pt-6">
         ...
         <a href="{{url('admin/branch_admin_branches')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i class="fa fa-times"></i></a>
         </form>
         {{-- paginate --}}
         <a href="{{route('branch_admin_branches.create')}}" class="btn btn-primary">Add</a>
         <!--end::Add customer-->
         </div>
         <!--end::Toolbar-->
         </div>
               ...
               <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
                  ...
                  <tbody class="fw-bold text-gray-600">
                     ...
                     <tr class="odd">
                        ...
                        <td>
                           <a href="branch_admin_branches/{{$admin->branch_id}}/edit">{{$admin->Branch->name}}</a>
                        </td>
                        ...
                        <td class="text-end">
                           ...
                           <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                              ...
                              <div class="menu-item px-3">
                                 <a href="branch_admin_branches/{{$admin->branch_id}}/edit" class="menu-link px-3">View</a>
                              </div>
                              <!--end::Menu item-->
                              <!--begin::Menu item-->
                              <div class="menu-item px-3">
