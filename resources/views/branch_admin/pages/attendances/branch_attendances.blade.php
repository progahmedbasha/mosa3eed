            ...
            <div class="col-xl-12 mb-30">
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <a href="{{route('bran_attendance_create',$id)}}"
                                    class="btn  btn-outline-primary">Add</a>
                            </div>
                            {{-- search --}}
                            <div class="col mb-3">
                                <form method="get" class="form-inline" action="{{url('branch_admin/attendances')}}"
                                    style="margin-left: 45%;">
                                    <input class=" form-control form-control-solid w-250px ps-15" name="search"
                                        type="text" placeholder="Search organization_attendances" required>
                                    <button type="submit" class="btn btn-light-primary me-3"><i
                                            class="fa fa-search"></i></button>
                                    <a href="{{url('branch_admin/attendances')}}" class="btn btn-light-primary me-3"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-icon-list">
                                                <form action="{{route('attendances.destroy',$org_attendance->id)}}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="attendances/{{$org_attendance->id}}/edit"
