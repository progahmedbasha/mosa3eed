               ...
               <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
                  ...
                  <thead>
                     ...
                     <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0" role="row">
                        ...
                        <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_customers_table" rowspan="1" colspan="1" aria-label=" Available Qty: activate to sort column ascending" style="width: 125px;">Available Qty</th>
                  ...
                  <tbody class="fw-bold text-gray-600">
                     ...
                     <tr class="odd">
                        ...
                        <!--begin::Name=-->
                        <td>
                           <a  class="text-gray-800 text-hover-primary mb-1">{{ $medicin->Medicin->name }}</a>
                        </td>
                        <td>
                           <a  class="text-gray-800 text-hover-primary mb-1">{{ $medicin->price }}</a>
                        </td>
                        <td>
                           <a  class="text-gray-800 text-hover-primary mb-1">{{ $medicin->available_quantity }}</a>
                        </td>
                        <!--end::Name=-->
                        <!--begin::Action=-->
                        <td class="text-end">
                           ...
                           <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                              ...
                              <div class="menu-item px-3">
                                 <a href="organization_branchs/{{$medicin->id}}/edit" class="menu-link px-3">View</a>
                              </div>
                              <!--end::Menu item-->
                              <!--begin::Menu item-->
                              <div class="menu-item px-3">
