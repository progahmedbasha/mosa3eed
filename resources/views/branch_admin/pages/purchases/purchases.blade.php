                     ...
                     <tr>
                        ...
                        <td>
                           <div class="btn-icon-list">
                              <form action="{{route('organization_purchases.destroy',$purchase->branch_id)}} " method="POST">
                                 @csrf
                                 @method('DELETE')
                                 <a href="organization_purchases/{{$purchase->branch_id}}/edit" class="btn btn-info"><i
