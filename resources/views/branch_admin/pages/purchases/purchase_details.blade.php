	...
	<div class="col-xl-12 mb-30">
		<div class="card card-statistics h-100">
			<div class="card-body">
				...
				<form action="{{route('branch_admin_purchases.update',$purchase->id)}}" method="post" enctype="multipart/form-data">
					@csrf
               @method('patch')
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<select id="country-dd" class="form-control" name="branch_id">
								...
								<option value="{{$branch->branch_id}}" {{($purchase->branch_id==$branch->branch_id)?
