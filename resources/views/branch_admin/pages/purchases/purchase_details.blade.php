			...
			<div class="col-xl-12 mb-30">
				<div class="card card-statistics h-100">
					<div class="card-body">
						...
						<form action="{{route('branch_admin_purchases.update',$purchase->id)}}" method="post"
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<select id="country-dd" class="form-control" name="branch_id">
										...
										<option value="{{$branch->branch_id}}" {{($purchase->
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control form-control-solid"
										placeholder="Acd Custom Item" value="{{ $purchase->acd }}" name="acd">
									@error('acd')
									<div class="alert alert-danger">{{ $message }}</div>
									@enderror
								</div>
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control form-control-solid"
										placeholder="Type Of Measurement" value="{{$purchase->type_measurement}}"
