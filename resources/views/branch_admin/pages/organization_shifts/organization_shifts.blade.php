         ...
         <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col mb-3">
                        <a href="{{ route('branch_shifts.create') }}" class="btn  btn-outline-primary">Add</a>
                     </div>
                     {{-- search --}}
                     <div class="col mb-3">
                        <form method="get" class="form-inline" action="{{url('branch_admin/branch_shifts')}}"
                           ...
                           <a href="{{url('branch_admin/branch_shifts')}}" class="btn btn-light-primary me-3"
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="btn-icon-list">
                                    <form action="{{route('branch_shifts.destroy',$shift->id)}}" method="POST">
                                       @csrf
                                       @method('DELETE')
                                       <a href="branch_shifts/{{$shift->id}}/edit" class="btn btn-info"><i
