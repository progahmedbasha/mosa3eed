            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-title">
                        <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">({{ $branch_name->name }}) Shift
                            List :</h1>
                    </div>
                </div>
            ...
            <div class="col-xl-12 mb-30">
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <a href="{{route('bran_shift_create',$id)}}" class="btn  btn-outline-primary">Add</a>
                            </div>
                            {{-- search --}}
                            <div class="col mb-3">
                                <form method="get" class="form-inline" action="{{url('admin/organization_shifts')}}"
                                    ...
                                    <input class=" form-control form-control-solid w-250px ps-15" name="search"
                                        type="text" placeholder="Search organization_shifts" required>
