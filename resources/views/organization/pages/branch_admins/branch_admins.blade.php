        ...
        <div class="top-category section-padding mb-4">
            ...
            <div class="row">
                <div class="col mb-3" style="margin-bottom:-1rem!important;">
                    <a href="{{ route('org_branch_admins_create',['org'	=> $org, 'branch' => $branch])}}" class="btn btn-primary">Add</a>
                </div>
            </div>
        </div>
        <hr>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="channels-card">
                    <div class="channels-card-image">
                        ...
                        <a href="{{route('org_branch_admin_edit', ['org' => $org , 'branch' => $admin->branch_id ,'id' =>$admin->user_id ])}}"><img
                                src="{{url('/data/admins')}}/{{$admin->User->photo }}" class="img-fluid" alt=""></a>
                        @else
                        <a href="{{route('org_branch_admin_edit', ['org' => $org , 'branch' => $admin->branch_id ,'id' =>$admin->user_id ])}}"><img src="{{url('/data/user_error.png')}}"
                        ...
                        <div class="channels-card-image-btn"><button type="button"
                                ...
                                href="{{route('org_branch_admin_edit', ['org' => $org , 'branch' => $admin->branch_id ,'id' =>$admin->user_id ])}}"
                    ...
                    <div class="channels-card-body">
                        ...
                        <div class="channels-view">
                            ...
                            <form action="{{route('org_branch_admins.destroy',$admin->user_id)}} " method="POST">
                                @csrf
                                @method('DELETE')
