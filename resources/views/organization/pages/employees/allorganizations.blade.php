                        ...
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                <form method="get" class="form-inline"
                                    action="{{url('organization/user_organizations')}}" style="margin-left: 40%;">
                                    ...
                                    <a href="{{url('organization/user_organizations')}}"
                                        class="btn btn-light-primary me-3" style="margin-top:0px;"><i
                            ...
                            <div class="col-xl-3 col-sm-6 mb-3">
                                <div class="video-card history-video">
                                    <div class="video-card-image">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                ...
                                                <li><a class="dropdown-item"
                                                        ...
                                                        href="org_branches/{{$organization->Organization->id}}"><i
                                                            class="fas fa-university"></i>
                                                        Branches</a>
                                                </li>
                                                <li><a class="dropdown-item"
                                                        style="padding: 0px 14px!important; font-size:14px;"
                                                        href="organiz_admins/{{ $organization->Organization->id }}"><i
                                        ...
                                        <a href="employees_org_branches/{{$organization->Organization->id}}">
