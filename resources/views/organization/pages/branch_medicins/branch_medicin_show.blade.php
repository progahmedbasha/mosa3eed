   ...
   <div class="col-xl-12 mb-30">
      <div class="card card-statistics h-100">
         <div class="card-body">
            ...
            <div class="row">
               <div class="col mb-3">
                  {{-- <a href="{{ route('branch_admin_branch_medicins.create') }}" class="btn
                  btn-outline-primary">Add</a> --}}
               </div>
               {{-- search --}}
               <div class="col mb-3">
                  <form method="get" class="form-inline" action="{{url('admin/branchs')}}" style="margin-left: 45%;">
                     ...
                     <a href="{{url('admin/branchs')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="btn-icon-list">
                              <form action="{{route('organization_branch_medicins.destroy',$medicin->id)}} " method="POST">
                                 @csrf
                                 @method('DELETE')
                                 <a href="organization_branch_medicins/{{$medicin->id}}/edit" class="btn btn-info"><i
