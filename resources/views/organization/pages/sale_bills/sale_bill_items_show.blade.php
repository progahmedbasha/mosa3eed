         ...
         <div class="row">
            <div class="col-md-12">
               <div class="main-title">
                  <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Order : #{{$sale_number->bill_number}}
                  </h1>
               </div>
            </div>
            ...
            <div class="card card-statistics h-100">
               <div class="card-body">
                  ...
                  <form method="get" class="form-inline" action="{{url('admin/sale_page')}}"
                     ...
                     <a href="{{url('admin/sale_page')}}" class="btn btn-light-primary me-3" style="margin-top:0px;"><i
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="btn-icon-list">
                                 <form
                                    action="{{route('org_order_item_delete',['order'	=> $id, 'id' => $sale_bill->id])}} "
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{route('org_item_edite', ['order'	=> $id, 'id' => $sale_bill->id] )}}"
