   ...
   <div class="container-fluid pb-0">
      <div class="top-category section-padding mb-4">
         ...
         <div class="row">
            <div class="col mb-3" style="margin-bottom:-1rem!important;">
               <a href="{{ route('org_admins_create',$id) }}" class="btn btn-primary">Add</a>
            </div>
      ...
      <div class="channels-card">
         <div class="channels-card-image">
            ...
            <a href=" {{route('org_admins.edit',$organization_admin->id)}} "><img
            ...
            <div class="channels-card-image-btn"><button type="button" class="btn btn-success btn-sm border-none">
               ...
               </button> <a href=" {{route('org_admins_edit', ['id'	=> $organization_admin->user_id, 'org' => $organization_name->id])}} "
