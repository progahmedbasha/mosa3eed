			...
			<div class="col-xl-12 mb-30">
				<div class="card card-statistics h-100">
					<div class="card-body">
						...
						<form action="{{route('organization_medicins.update',$medicin->id)}}" method="post"
							...
							<div class="form-row">
								<div class="col">
									...
									<input type="text" class="form-control" placeholder="Name En"
										value="{{$medicin->getTranslation('name', 'en')}}" name="name_en" required />
									@error('name_en')
								...
								<div class="col">
									...
									<input type="text" class="form-control" placeholder="Name Ar"
										value="{{$medicin->getTranslation('name', 'ar')}}" name="name_ar" required />
									@error('name_ar')
									<div class="alert alert-danger">{{ $message }}</div>
									@enderror
								</div>
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control" placeholder="Price"
										value="{{$medicin->price}}" name="price">
									@error('price')
									<div class="alert alert-danger">{{ $message }}</div>
									@enderror
								</div>
