         ...
         <div class="col-xl-3 col-sm-6 mb-3">
            <div class="channels-card">
               <div class="channels-card-image">
                  ...
                  <a href="{{route('organization_admin_edit', [ 'user_id' => $user->user_id , 'id' => $user->id] )}}"><img
                        src="{{url('/data/admins')}}/{{$user->User->photo }}" class="img-fluid" alt=""></a>
                  @else
                  <a href="{{route('organization_admin_edit', [ 'user_id' => $user->user_id , 'id' => $user->id] )}}"><img
                  ...
                  <div class="channels-card-image-btn"><button type="button" class="btn btn-success btn-sm border-none">
                        ...
                        href="{{route('organization_admin_edit', [ 'user_id' => $user->user_id , 'id' => $user->id] )}}"
