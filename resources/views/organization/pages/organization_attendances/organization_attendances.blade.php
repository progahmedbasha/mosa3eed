            ...
            <div class="card card-statistics h-100">
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     {{-- search --}}
                     <div class="col mb-3">
                        <form method="get" class="form-inline" action="{{url('organization/org_attendances')}}"
                           ...
                           <a href="{{url('organization/org_attendances')}}" class="btn btn-light-primary me-3"
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="btn-icon-list">
                                    <form action="{{route('org_attendances.destroy',$org_attendance->id)}}"
                                       method="POST">
                                       @csrf
                                       @method('DELETE')
                                       <a href="org_attendances/{{$org_attendance->id}}/edit"
