            ...
            <div class="col-xl-12 mb-30">
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        ...
                        <form action="{{route('org_attendances.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <select id="organization" class="form-control organization_id" name="organization_id">
                                        ...
                                        <option value="{{$org->Organization->id}}" {{(old('organization_id')==$org->
                                            Organization->id)?
                                            'selected':''}}>{{$org->Organization->name}}</option>
                                        @endforeach
                                    </select>
