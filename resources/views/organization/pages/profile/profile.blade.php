	...
	<div class="col-xl-12 mb-30">
		<div class="card card-statistics h-100">
			<div class="card-body">
				...
				<form action="{{route('organization_profile.update',$organization->id)}}" method="post"
					...
					<div class="form-row">
						<div class="col">
							...
							<input type="text" class="form-control form-control-solid" placeholder="Name En"
								value="{{$organization->getTranslation('name', 'en')}}" name="name_en">
							@error('name_en')
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control form-control-solid" placeholder="Contact En"
								value="{{$organization->getTranslation('contact_name', 'en')}}" name="contact_en">
							@error('contact_en')
							<div class="alert alert-danger">{{ $message }}</div>
							@enderror
						</div>
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control form-control-solid" placeholder="Contact Ar"
								value="{{$organization->getTranslation('contact_name', 'en')}}" name="contact_ar">
							@error('contact_ar')
							<div class="alert alert-danger">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							<label for="inputName">Verified status</label>
							<select class="form-control" name="status">
								<option value="{{ $organization->status }}">{{ $organization->status }}
								</option>
