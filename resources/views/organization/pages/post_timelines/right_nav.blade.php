@include('organization.pages.post_timelines.ads_modal_component')
            ...
            <div class="col-md-12">
                    ...
                    <div class="video-card-body">
                        <div class="btn-group float-right right-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <form action="{{route('org_ads.destroy',$ad->id)}} " method="POST">
                                    @csrf
                                    @method('DELETE')
                        ...
                        @include('organization.pages.post_timelines.edit_ad_modal')
                ...
                <div class="adblock mt-0" style="padding:0px 0px;">
                    <div class="btn-group float-right right-action" style="position: absolute;">
                     ...
                     @include('organization.pages.post_timelines.edit_ad_modal_only_pic')
                    {{-- <div class="img"> --}}
