   ...
   <div class="col-xl-12 mb-30">
      <div class="card card-statistics h-100">
         <div class="card-body">
            ...
            <div class="row">
               <div class="col mb-3">
                  <a href="{{ route('organization_timeline_posts.create') }}" class="btn  btn-outline-primary">Add</a>
               </div>
               {{-- search --}}
               <div class="col mb-3">
                  <form method="get" class="form-inline" action="{{url('admin/organization_timeline_posts')}}"
                     ...
                     <a href="{{url('admin/organization_timeline_posts')}}" class="btn btn-light-primary me-3"
               ...
               <table id="datatable" class="table table-striped table-bordered p-0">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="org_post_comment/{{$post_timeline->id}}">{{$post_timeline->post_comment_count}}</a>
                        </td>
                        ...
                        <td>
                           <div class="btn-icon-list">
                              <form action="{{route('organization_timeline_posts.destroy',$post_timeline->id)}}" method="POST">
                                 @csrf
                                 @method('DELETE')
                                 <a href="organization_timeline_posts/{{$post_timeline->id}}/edit" class="btn btn-info"><i
