         ...
         <div class="row">
            <div class="col-md-8">
               <div class="single-video-left">
                  ...
                  @include('organization.pages.post_timelines.add_post_component')
                        ...
                        <div class="tab-pane fade show active" id="retro-comments" role="tabpanel"
                           ...
                           <div class="reviews-members">
                              <div class="media">
                                 ...
                                 <a href="organization_timeline_posts/{{$post_timeline->id}}/edit"><img
                                 ...
                                 <div class="media-body">
                                    <div class="reviews-members-header">
                                       ...
                                       <div class="dropdown" style="margin-left: 100%; margin-top: -3%;">
                                          ...
                                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                             ...
                                             View & Edit</button>
                                             <li>
                                                <form action="{{route('organization_timeline_posts.destroy',$post_timeline->id)}} "
                                                   method="POST">
                                                   @csrf
                                                   @method('DELETE')
                                    ...
                                    <br>
                                    @include('organization.pages.post_timelines.edit_post_modal')
            ...
            @include('organization.pages.post_timelines.right_nav')
         </div>
      </div>
      <hr>
   </div>
     ...
     $(document).ready(function(){
             ...
             $('.actives').on('click ', function (e) {
               ...
               //   var new_id = $('.new_id').val();
                 ...
                 $.ajax({
                     url: "{{route('org_change_comment_satus')}}",
                     type: "POST",
                     data: {
                         active: active,
                         new_id:new_id,
   ...
   ////add comment to post
     function commentFunction(id , inputad,div) {
      //   console.log(inputad);
                 ...
                 $.ajax({
                     url: "{{route('org_add_comment_ajax')}}",
                     type: "POST",
                     data: {
                         id:id,
                         input_id:input_id,
