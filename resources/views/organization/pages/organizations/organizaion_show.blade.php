         ...
         <div class="card card-statistics h-100">
            <div class="card-body">
               <div class="row" style="display: contents;">
                  <h5 class="card-title">
                     <a href=" {{route('user_organizations.edit',$organization->id)}}"><i class="fas fa-edit"></i>
                     Edit
                     </a>
                  </h5>
               </div>
      ...
      <div class="col-xl-12 mb-30">
         <div class="card card-statistics h-100">
            <div class="card-body">
               <div class="row">
                  <div class="col mb-3">
                     <a href="{{ route('org_branch_add', $organization->id) }}" class="btn  btn-outline-primary">Add</a>
                  </div>
               </div>
   ...
   <div class="top-category section-padding mb-4">
      ...
      <div class="row">
         <div class="col mb-3" style="margin-bottom:-1rem!important;">
            <a href="{{ route('org_admins_create',$organization->id) }}" class="btn btn-primary">Add</a>
         </div>
      </div>
   </div>
   <div class="row">
      ...
      <div class="col-xl-3 col-sm-6 mb-3">
         <div class="channels-card">
            <div class="channels-card-image">
               ...
               <a href=" {{route('org_admins_edit', [ 'id' => $organization_admin->user_id , 'org' => $organization_admin->id] )}} "><img
               ...
               <div class="channels-card-image-btn"><button type="button" class="btn btn-success btn-sm border-none">
                  ...
                  </button> <a href=" {{route('org_admins_edit', [ 'id' => $organization_admin->user_id , 'org' => $organization_admin->id] )}}  "
            ...
            <div class="channels-card-body">
               ...
               <div class="channels-view">
                  ...
                  <form action="{{route('org_admins.destroy',$organization_admin->id)}} " method="POST">
                     @csrf
                     @method('DELETE')
                  ...
                  <table id="datatable" class="table table-striped table-bordered p-0">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="btn-icon-list">
                                 <form action="{{route('org_branch_admins.destroy',$branch_admin->id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{route('org_branch_admin_edit', ['org' => $branch_admin->organization_id , 'branch' => $branch_admin->branch_id ,'id' =>$branch_admin->user_id ])}}" class="btn btn-info"><i
                                       class="fa fa-edit"></i></a>
                                    <button class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                 </form>
                              </div>
