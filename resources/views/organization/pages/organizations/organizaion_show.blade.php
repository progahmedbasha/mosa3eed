         ...
         <div class="col-xl-3 col-sm-6 mb-3">
            <div class="channels-card">
               <div class="channels-card-image">
                  ...
                  <a href=" {{route('organization_admin_edit', [ 'user_id' => $organization_admin->user_id , 'id' => $organization_admin->id] )}} "><img
                  ...
                  <div class="channels-card-image-btn"><button type="button" class="btn btn-success btn-sm border-none">
                     ...
                     </button> <a href=" {{route('organization_admin_edit', [ 'user_id' => $organization_admin->user_id , 'id' => $organization_admin->id] )}} "
               ...
               <div class="channels-card-body">
                  ...
                  <div class="channels-view">
                     ...
                     <form action="{{route('pharmacy_admins.destroy',$organization_admin->id)}} " method="POST">
                        @csrf
                        @method('DELETE')
