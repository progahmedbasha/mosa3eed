               ...
               <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_customers_table" role="grid">
                  ...
                  <tbody class="fw-bold text-gray-600">
                     ...
                     <tr class="odd">
                        ...
                        <!--begin::Name=-->
                        <td>
                           <a href="organization_branchs/{{$branch->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $branch->name }}</a>
                        </td>
                        <!--end::Name=-->
                        <!--begin::Name=-->
                        <td>
                           <a href="organization_branchs/{{$branch->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $branch->Organization->name }}</a>
                        </td>
                        <td>
                           <a href="organization_branchs/{{$branch->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $branch->email }}</a>
                        </td>
                        <td>
                           <a href="organization_branchs/{{$branch->id}}/edit" class="text-gray-800 text-hover-primary mb-1">{{ $branch->address }}</a>
                        </td>
                        <!--end::Name=-->
                        <!--begin::Action=-->
                        <td class="text-end">
