				...
				<form action="{{route('organization_branchs.update',$branch->id)}}" method="post" enctype="multipart/form-data">
					...
					<div class="form-row">
						<div class="col">
							...
							<input type="text" class="form-control" placeholder="Phone 1" value="{{$branch->phone_1}}"
								name="phone_1" />
							@error('phone_1')
							<div class="alert alert-danger">{{ $message }}</div>
							@enderror
						...
						<div class="col">
							...
							<input type="text" class="form-control" placeholder="Phone 2" value="{{$branch->phone_2}}"
	...
	<div class="col-xl-12 mb-30">
		<div class="card card-statistics h-100">
			<div class="card-body">
				...
				<img src="{{url('/data/branchs')}}/{{$branch->photo }}" class="w3-round" width="200px" alt="Norway">
				@else
